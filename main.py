...
def get_args_parser():
    parser = argparse.ArgumentParser('Set gestalt-perception transformer detector', add_help=False)
    ...
    parser.add_argument('--dim_feedforward', default=512, type=int, help="Intermediate size of the feedforward layers in the transformer blocks")
    ...
    parser.add_argument('--coco_path', default='./data_dir/coco/', type=str)
...
def main(args):
    ...
    data_loader_val = DataLoader(dataset_val, args.batch_size, sampler=sampler_val, drop_last=True, collate_fn=utils.collate_fn, num_workers=args.num_workers)
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser('Gestalt DETR training and evaluation script', parents=[get_args_parser()])
